...
Once this is working add the following features:

- add an option to switch language (en, fr, ...)
- add an option to list the languages ohce knows
- allow configuration for times of the day when ohce changes greetings
